...
To use the getting started examples, make sure you have the following
information and complete any necessary configuration work.

- Rackspace Cloud account
- Username and password to access the account
- API key to access Rackspace Cloud services
- Account number
- :ref:`Command line tool or browser client <send-api-requests>` to communicate
  with the API service
- Configure environment variables in
  :ref:`cURL<configure-environment-variables>`

If you don't have an account, `sign up`_ for one.
You can find your account number and API key on the Account Settings page in
