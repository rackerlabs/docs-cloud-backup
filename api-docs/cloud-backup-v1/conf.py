...
htmlhelp_basename = 'RackspaceCloudApiBackupDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCloudApiBackupDeveloperDoc.tex', 'Rackspace Cloud Backup API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudApiBackupDeveloperDoc', 'Rackspace Cloud Backup API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudApiBackupDeveloperDoc', 'Rackspace Cloud Backup API Developer Guide',
   'Rackspace', 'RackspaceCloudApiBackupDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Backup service.',
   'Miscellaneous'),
]
