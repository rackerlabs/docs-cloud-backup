...
Authentication
~~~~~~~~~~~~~~
Each REST request against the Cloud Backup service requires the inclusion of a
specific authorization token, supplied in the ``X-Auth-Token`` HTTP header of
