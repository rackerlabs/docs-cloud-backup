...
When determining how often to back up a file in your backup configuration, consider
...
Criticality is the most important factor to consider when making backup decisions.
The more critical the file is to your business operations, the more often you
should back up the file.
