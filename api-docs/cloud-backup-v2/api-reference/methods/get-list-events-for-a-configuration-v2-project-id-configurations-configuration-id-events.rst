...
*  ``GET /v2/backups/{id}/events`` (See
   :ref:`Retrieve the events for a backup <get-list-events-for-a-backup>`.)
*  ``GET /v2/restores/{id}/events`` (See
   :ref:`Retrieve the events for a restore <get-list-events-for-a-restore>`.)
