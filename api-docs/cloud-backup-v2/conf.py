...
project = 'Rackspace Cloud Backup v2'
copyright = '2016'
author = 'Rackspace'
...
# html_title = 'Rackspace Cloud Backup v2 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'Rackspace Cloud Backup v2 API'
...
htmlhelp_basename = 'docs-cloud-backup'
...
latex_documents = [
  (master_doc, 'docs-cloud-backup.tex',
   'Rackspace Cloud Backup API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Backup API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-backup', 'Rackspace Cloud Backup API Documentation',
   'Rackspace', 'docs-cloud-backup', 'Learn about using the Product',
   'Miscellaneous'),
]
