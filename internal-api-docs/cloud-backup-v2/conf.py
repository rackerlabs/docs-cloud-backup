...
rst_epilog = """
.. |apiservice| replace:: Rackspace Cloud Backup Administration API
.. |no changes| replace:: None for this release.
.. |contract version| replace:: 2
...
#html_last_updated_fmt = ‘October 5, 2015’
...
htmlhelp_basename = 'RackspaceCBUApiDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCBUApiDeveloperDoc.tex', 'Rackspace Cloud Backup API Admin Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCBUpiDeveloperDoc', 'Rackspace Cloud Backup API Admin Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCBUApiDeveloperDoc', 'Rackspace Cloud Backup API Admin Guide',
   'Rackspace', 'RackspaceCBUApiDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Backup service.',
   'Miscellaneous'),
]
