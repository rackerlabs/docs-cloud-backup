...
`Request <POST_update_a_restore_configuration_v1.0_tenant_id_restore.rst#request>`__
`Response <POST_update_a_restore_configuration_v1.0_tenant_id_restore.rst#response>`__
