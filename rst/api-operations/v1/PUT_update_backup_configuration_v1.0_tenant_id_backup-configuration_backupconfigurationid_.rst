...
`Request <PUT_update_backup_configuration_v1.0_tenant_id_backup-configuration_backupconfigurationid_.rst#request>`__
`Response <PUT_update_backup_configuration_v1.0_tenant_id_backup-configuration_backupconfigurationid_.rst#response>`__
