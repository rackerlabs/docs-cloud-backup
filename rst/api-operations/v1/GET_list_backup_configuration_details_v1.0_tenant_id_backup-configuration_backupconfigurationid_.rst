...
`Request <GET_list_backup_configuration_details_v1.0_tenant_id_backup-configuration_backupconfigurationid_.rst#request>`__
`Response <GET_list_backup_configuration_details_v1.0_tenant_id_backup-configuration_backupconfigurationid_.rst#response>`__
