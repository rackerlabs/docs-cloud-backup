...
`Request <GET_list_included_or_excluded_files_in_a_restore_configuration_v1.0_tenant_id_restore_files_restoreid_.rst#request>`__
`Response <GET_list_included_or_excluded_files_in_a_restore_configuration_v1.0_tenant_id_restore_files_restoreid_.rst#response>`__
