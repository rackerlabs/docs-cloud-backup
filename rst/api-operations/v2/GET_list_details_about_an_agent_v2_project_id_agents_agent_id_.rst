...
`Request <GET_list_details_about_an_agent_v2_project_id_agents_agent_id_.rst#request>`__
`Response <GET_list_details_about_an_agent_v2_project_id_agents_agent_id_.rst#response>`__
