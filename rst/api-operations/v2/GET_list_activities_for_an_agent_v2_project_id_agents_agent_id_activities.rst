...
`Request <GET_list_activities_for_an_agent_v2_project_id_agents_agent_id_activities.rst#request>`__
`Response <GET_list_activities_for_an_agent_v2_project_id_agents_agent_id_activities.rst#response>`__
...
This operation lists the following activities for the specified agent: Backups performed by the agent Restores performed when the agent is the destination Cleanups performed by the agent
