...
`Request <DELETE_delete_an_agent_v2_project_id_agents_agent_id_.rst#request>`__
`Response <DELETE_delete_an_agent_v2_project_id_agents_agent_id_.rst#response>`__
