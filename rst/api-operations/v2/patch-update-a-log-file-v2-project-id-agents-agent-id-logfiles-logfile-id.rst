...
`Request <patch-update-a-log-file-v2-project-id-agents-agent-id-logfiles-logfile-id.html#request>`__
`Response <patch-update-a-log-file-v2-project-id-agents-agent-id-logfiles-logfile-id.html#response>`__
