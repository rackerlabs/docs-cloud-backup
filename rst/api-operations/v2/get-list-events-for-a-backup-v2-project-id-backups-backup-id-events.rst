...
`Request <get-list-events-for-a-backup-v2-project-id-backups-backup-id-events.html#request>`__
`Response <get-list-events-for-a-backup-v2-project-id-backups-backup-id-events.html#response>`__
