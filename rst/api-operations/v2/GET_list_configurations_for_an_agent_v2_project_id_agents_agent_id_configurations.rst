...
`Request <GET_list_configurations_for_an_agent_v2_project_id_agents_agent_id_configurations.rst#request>`__
`Response <GET_list_configurations_for_an_agent_v2_project_id_agents_agent_id_configurations.rst#response>`__
