...
.. note::
   To view a list of all backup configurations and their backup configuration schedule IDs, see :ref:`List backup configuration details <get-backup-configuration-details>`.
